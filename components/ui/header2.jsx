...
export default function Header() {
    ...
    return (
        <header className={`fixed w-full px-1 md:px-16 z-30 md:bg-opacity-90 transition duration-300 ease-in-out ${!top ? 'bg-zinc-700 backdrop-blur-sm shadow-lg' : ''}`} style={{ zIndex: 9999 }}>
                ...
                <div className="flex flex-row items-center justify-between h-16 md:h-20">
                    ...
                    <div className="flex flex-col items-start">
                        ...
                        <Link href="/" className=" flex items-start">
                            ...
                            <svg width="120" height="40" className="-mx-3" viewBox="0 0 300 100" version="1.1" style={{
                                ...
                                <g fill={"#fff"} transform="matrix(1,0,0,1,20.0316,-1.12926)">
                                    < text x="11.941px" y="68.911px" style={{ fontFamily: "'AvenirNext-Bold', 'Avenir Next', sans-serif", fontWeight: 700, fontSize: "68.921px" }}>G<tspan x="67.009px 112.635px 140.341px 183.486px 206.092px " y="68.911px 68.911px 68.911px 68.911px 68.911px" fill="#fff">otely</tspan></text>
                                </g>
                            </svg >
                        </Link>

                        <span className=" text-sm font-extralight text-white">| Powered by CW1</span>
                    ...
                    <nav className="hidden md:flex">
                        ...
                        <ul className="flex grow justify-end flex-wrap items-center">
                            <li>
                                <a href="https://app.gotely.com" className="flex items-center md:px-4 px-3 md:py-1 py-1 text-zinc-800 bg-zinc-50 hover:bg-zinc-200 border border-zinc-800 ml-3 cursor-pointer rounded-full ">
